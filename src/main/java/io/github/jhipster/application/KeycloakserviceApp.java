...
public class KeycloakserviceApp {

    private static final Logger log = LoggerFactory.getLogger(KeycloakserviceApp.class);

    private final Environment env;

    public KeycloakserviceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes keycloakservice.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KeycloakserviceApp.class);
